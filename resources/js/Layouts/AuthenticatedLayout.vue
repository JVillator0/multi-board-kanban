            ...
            <nav class="bg-white border-b border-gray-100">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink :href="route('boards.index')" :active="(
                                    route().current('boards.index') ||
                                    route().current('boards.show') ||
                                    route().current('boards.create') ||
                                    route().current('boards.edit') ||
                                    route().current('boards.invitations.index')
                                )">
                                    Boards
                                </NavLink>
                            </div>
                ...
                >
                    <div class="pt-2 pb-3 space-y-1">
                        <ResponsiveNavLink :href="route('boards.index')" :active="route().current('boards.index')">
                            Boards
                        </ResponsiveNavLink>
                    </div>
